...
const projects = [
  ...
  },
  {
    ...
    link: "/projects/AIMachineLearning",
  },
];
...
export default function ProjectsPage() {
  return (
    <div className="max-w-7xl mx-auto relative min-h-screen flex flex-col justify-start w-full bg-[black] light:bg-white pt-6 sm:pt-4">
      ...
      >
        I’ve worked across a range of areas that blend technology,
        problem-solving, and data-driven insights. My projects span software
        applications, where I design and build user-friendly tools, to
        operations research, where I tackle complex real-world challenges using
        analytical methods. I also focus on machine learning, applying
        algorithms and data science to uncover patterns and drive smarter
        decisions. Each area reflects my passion for turning ideas into
        practical solutions.
      </Typography>
          ...
          {projects.map((project) => (
            ...
            >
              ...
              >
                ...
                {/* Title */}
                <h2
                  className="mt-4 text-2xl font-extrabold text-[#FFB6C1] text-center md:text-xl sm:text-lg 
