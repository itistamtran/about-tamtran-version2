...
import AIMachineLearning from "./containers/projects/AIMachineLearning";
...
import BrainTumorDetectedCNN from "./containers/allprojects/BrainTumorDetectedCNN";
import BrainTumorDetectedViT from "./containers/allprojects/BrainTumorDetectedViT";
...
import AIAssignments from "./containers/allprojects/AIAssignments";
  ...
  useEffect(() => {
    ...
    loadZodiacData().then((data) => {
      ...
      if (Object.keys(data).length === 0)
        console.error("❌ No constellations loaded!");
    ...
    <Router>
      ...
      >
        ...
        <Routes>
              ...
              <div>
                ...
                >
                  ...
                  >
                    ...
                    <br /> AI Engineer | Building real-world solutions with code
                    and creativity
                  </div>
                  ...
                  {!webglSupported && (
                    ...
                    >
                      <source
                        src="/media/4k-SPACE-Moving-Background.mp4"
                        type="video/mp4"
                      />
                ...
                >
                  ...
                  >
                    ...
                    >
                      I am passionate about harnessing the power of artificial
                      intelligence to solve real-world challenges and advance
                      meaningful innovation. As a Computer Science student with
                      strong foundations in Data Science and Mathematics, I
                      thrive at the intersection of research and technology,
                      where curiosity drives discovery and practical solutions.
                      <br />
                      <span
                        style={{ display: "block", height: "0.5em" }}
                      ></span>
                      My projects showcase hands-on experience in AI
                      development, from machine learning models to data-driven
                      applications. I am committed to ongoing learning, actively
                      exploring the latest research and applying new techniques
                      to build smarter, more impactful technology.
                      <br />
                      <span
                        style={{ display: "block", height: "0.5em" }}
                      ></span>
                      I invite you to explore my work and see how my skills,
                      determination, and vision can make a positive impact.
                    ...
                    <motion.button
                      ...
                      onClick={() => {
                        document
                          .getElementById("feature-highlights")
                  ...
                  >
                    ...
                    <div className="features-grid">
                      ...
                      >
                        <FeatureCard
                          title="Project"
                          description="Check out my projects that showcase my problem-solving skills."
                          link="/projects"
                      ...
                      >
                        <FeatureCard
                          title="Experience"
                          description="With hands-on experience, I apply my skills to deliver innovative solutions."
                          link="/resume"
                          image="/media/experience-1.jpg"
                        />
                      </motion.div>
                      ...
                      >
                        <FeatureCard
                          title="For Sale"
                          description="Explore the digital images I’ve created to find the perfect piece for your style."
                          link="/forsale"
                          image="/media/forsale-1.jpg"
                        />
                      </motion.div>
                    </div>
                  </div>
          ...
          <Route
            path="/projects/SoftwareApplications"
            element={<SoftwareApplications />}
          />
          <Route
            path="/projects/OperationsResearch"
            element={<OperationsResearch />}
          />
          <Route
            path="/projects/AIMachineLearning"
          ...
          <Route
            path="/allprojects/NurseSchedule"
            element={<NurseSchedule />}
          />
          <Route
            path="/allprojects/KnapsackLogistics"
            element={<KnapsackLogistics />}
          />
          <Route
            path="/allprojects/BrainTumorDetectedCNN"
            element={<BrainTumorDetectedCNN />}
          />
          <Route
            path="/allprojects/BrainTumorDetectedViT"
            element={<BrainTumorDetectedViT />}
          />
          <Route
            path="/allprojects/MarketTrendLSTM"
            element={<MarketTrendLSTM />}
          />
          <Route
            path="/allprojects/ToxicCommentClassification"
            element={<ToxicCommentClassification />}
          />
          <Route path="/allprojects/MedScanAI" element={<MedScanAI />} />
          <Route
            path="/allprojects/AIAssignments"
            element={<AIAssignments />}
          />
        </Routes>
        <Footer />
      </div>
